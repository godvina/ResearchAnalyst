...
def parse_args() -> BatchConfig:
    ...
    parser.add_argument(
        ...
        help="S3 prefixes to scan for raw PDFs (default: pdfs/ bw-documents/)",
    )
    parser.add_argument(
        "--source-bucket", type=str, default="doj-cases-974220725866-us-east-1",
        help="S3 bucket containing raw source files (default: doj-cases-974220725866-us-east-1)",
    )
